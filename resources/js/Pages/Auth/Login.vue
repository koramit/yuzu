            ...
            <!-- <div class="mt-4 rounded-lg shadow p-4 bg-thick-theme-light text-white font-semibold">
                ...
                <div class="mt-4">
                    <p class="mt-2 italic text-xs">
                        <span class="underline">วันที่ 20 ม.ค. 2565 เวลา 16:30 - 17:00 น.</span> โดยประมาณ หน่วยเวชสารสนเทศ ภาควิชาอายุรศาสตร์ <span class="underline">จะทำการ</span>เปลี่ยนอุปกรณ์เครื่องสำรองไฟที่ชำรุด
                    </p>
