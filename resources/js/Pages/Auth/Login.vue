            ...
            <div class="mt-4 rounded-lg shadow p-4 bg-thick-theme-light text-white font-semibold">
                ...
                <div class="mt-4">
                    ...
                    <p class="mt-2 text-xs">
                        หากมีผู้ป่วยยังไม่ได้จำหน่ายค้างในระบบ สามารถดำเนินการต่อได้หลังช่วงเวลาดังกล่าว ขออภัยในความไม่สะดวก 🙏🙏🙏
                    </p>
                </div>
                <div class="mt-4">
                    <p class="mt-2 italic text-xs">
                        และในเวลา 22:00 - 23:00 น. ฝ่ายสารสนเทศ คณะฯ จะทำการบำรุงรักษาเครื่องแม่ข่าย ทำให้การใช้งานดังต่อไปนี้ไม่สามารถทำได้ในช่วงเวลาดังกล่าว
                    </p>
                    <p class="mt-2 text-xs">
                        ๏ Login เข้าใช้งาน
                    </p>
