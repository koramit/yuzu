...
class AbilityRoleTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Ability::insert([
            ...
            ['name' => 'view_manage_list'] + $datetime,
            ...
            ['name' => 'manage_swab'] + $datetime, // nurse manage swab
        ...
        $assignment = [
            ...
            'nurse' => ['create_visit', 'view_screen_list', 'view_exam_list', 'view_swab_list', 'view_mr_list', 'view_queue_list', 'view_manage_swab_list', 'view_any_visits', 'update_visit', 'sign_on_behalf', 'enlist_exam', 'manage_swab', 'print_opd_card', 'replace_visit', 'cancel_visit', 'export_visits'],
